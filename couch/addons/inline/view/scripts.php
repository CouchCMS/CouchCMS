        ...
        if( inline ){
            editor.on( 'configLoaded', function(){
                ...
                <?php if( K_USE_KC_FINDER ): ?>
                    editor.config['filebrowserBrowseUrl'] = '<?php echo K_ADMIN_URL; ?>includes/kcfinder/browse.php?cms=couch&type=file';
                    editor.config['filebrowserImageBrowseUrl'] = '<?php echo K_ADMIN_URL; ?>includes/kcfinder/browse.php?cms=couch&type=image';
