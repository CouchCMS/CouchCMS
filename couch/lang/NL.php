<?php
	...
	$t['insufficient_privileges'] = 'U beschikt niet over genoeg machtigingen om de pagina te bekijken. Gelieve uit te loggen en opnieuw in te loggen met de correcte machtigingen.';

	// Password recovery
	$t['recovery_prompt'] = 'Gelieve uw gebruikersnaam of email adres te bevestigen.<br/> U zult uw paswoord via mail ontvangen.';
	...
	$t['original_deleted'] = 'ORIGINEEL VERWIJDERD'; //in Caps
